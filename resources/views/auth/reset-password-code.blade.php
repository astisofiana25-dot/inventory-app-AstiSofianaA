...
<div class="bg-white rounded-3xl shadow-2xl p-8">
    <div class="text-center mb-8">
        ...
        <p class="text-gray-500 text-sm">Masukkan password baru dan konfirmasi password.</p>
    </div>

    <x-alert />

    <form method="POST" action="{{ route('password.reset.code.submit') }}" class="space-y-5">
        @csrf
